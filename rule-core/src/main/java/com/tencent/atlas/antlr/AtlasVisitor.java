...
import com.tencent.atlas.feature.org.antlr.v4.runtime.tree.ParseTreeVisitor;
...
public interface AtlasVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitCaseFunctionCall(AtlasParser.CaseFunctionCallContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIfFunctionCall(AtlasParser.IfFunctionCallContext ctx);
	/**
	 * Visit a parse tree produced by {@link AtlasParser#caseFuncAlternative}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCaseFuncAlternative(AtlasParser.CaseFuncAlternativeContext ctx);
	/**
